...
for counter in range(0,int(x)):
  ...
  for newcounter in range(0,3):
    ...
    dir2 = "/home/dkoes/PDBbind/refined-set/new/new" + str(files) + "pdbtest" + str(newcounter)+ ".types"
    cmd2 = "more " + dir1 + " > " + dir2
    os.system(cmd2)
    
    dir1 = "/home/dkoes/PDBbind/refined-set/pdbbindtrain" + str(newcounter) + ".types"
    dir2 = "/home/dkoes/PDBbind/refined-set/new/new" + str(files) + "pdbtrain" + str(newcounter) + ".types"
